...
public class LoginAction extends BaseAction {
    ...
    //根据id查询用户
    @RequestMapping(params = "method=QueryUserById")
    public ModelAndView QueryUserById(HttpServletRequest req, HttpServletResponse res) {
        //页面参数
        Map<String, String> param  = this.getParameterMap(req);
        //获取数据
        Map dataMap = this.loginService.QueryUserById(param);
        // 写回客户端
        this.WriteJsonObjToPage(dataMap, res);
        // 返回
        return null;
